...
<p align="center">
  <a href="https://www.npmjs.com/package/pi-ynabro"><img src="https://img.shields.io/npm/v/pi-ynabro.svg?style=flat-square" alt="npm version"></a>
...
Pi extension that registers [ynabro](https://www.npmjs.com/package/ynabro) tools for YNAB integration.

## Installation

```bash
pi install npm:pi-ynabro
```
